...
- 0.06.0 这轮发布主要更新了桌面工具侧的诊断收口、工作台布局和交付文档，没有修改 `unity_package/Assets/AudioForgeRuntime` 下的 Unity 运行时代码。
...
- `AudioForgeUnityPackage-0.06.0/`
- `AudioForgeUnityPackage-0.06.0.zip`
