...
- Unity runtime 已支持 emitter handle、SetState、SetSwitch、SetGameParameter、Schema v3 初始化、Bus GameSync 求值和 validation smoke；详细设计与当前边界见 `docs/unity/architecture/UnityRuntime三期GameSync设计.md`。
